...
public class DayYearToDayMonth {
    public static void main(String[] args) {
        // Create an instance of calendar for the year 2007 and set its day to
        ...
        // To know what day in month of the calendar we can obtain the value
        // by calling Calendar's instance get() method and pass the
        // Calendar.DAY_OF_MONTH field.
        int dayOfMonth = cal.get(Calendar.DAY_OF_MONTH);

        // Print which month day is it in number.
        System.out.println("Calendar day of month: " + dayOfMonth);

        // To know what day in week of the calendar we can obtain the value
        // by calling Calendar's instance get() method and pass the
